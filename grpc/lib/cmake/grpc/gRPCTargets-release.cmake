...
set_target_properties(gRPC::absl_bad_optional_access PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_bad_optional_access.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_bad_optional_access )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_bad_optional_access "${_IMPORT_PREFIX}/lib/libabsl_absl_bad_optional_access.a" )
...
set_target_properties(gRPC::absl_base PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_base.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_base )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_base "${_IMPORT_PREFIX}/lib/libabsl_absl_base.a" )
...
set_target_properties(gRPC::absl_dynamic_annotations PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_dynamic_annotations.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_dynamic_annotations )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_dynamic_annotations "${_IMPORT_PREFIX}/lib/libabsl_absl_dynamic_annotations.a" )
...
set_target_properties(gRPC::absl_int128 PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_int128.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_int128 )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_int128 "${_IMPORT_PREFIX}/lib/libabsl_absl_int128.a" )
...
set_target_properties(gRPC::absl_log_severity PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_log_severity.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_log_severity )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_log_severity "${_IMPORT_PREFIX}/lib/libabsl_absl_log_severity.a" )
...
set_target_properties(gRPC::absl_raw_logging_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_raw_logging_internal.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_raw_logging_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_raw_logging_internal "${_IMPORT_PREFIX}/lib/libabsl_absl_raw_logging_internal.a" )
...
set_target_properties(gRPC::absl_spinlock_wait PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_spinlock_wait.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_spinlock_wait )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_spinlock_wait "${_IMPORT_PREFIX}/lib/libabsl_absl_spinlock_wait.a" )
...
set_target_properties(gRPC::absl_strings PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_strings.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_strings )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_strings "${_IMPORT_PREFIX}/lib/libabsl_absl_strings.a" )
...
set_target_properties(gRPC::absl_strings_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_strings_internal.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_strings_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_strings_internal "${_IMPORT_PREFIX}/lib/libabsl_absl_strings_internal.a" )
...
set_target_properties(gRPC::absl_throw_delegate PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libabsl_absl_throw_delegate.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::absl_throw_delegate )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::absl_throw_delegate "${_IMPORT_PREFIX}/lib/libabsl_absl_throw_delegate.a" )
